    ...
    if (view instanceof MarkdownView) {
      ...
      prettifier(text, this.settings, { today: moment(), tags: [] })
        .then((data) => {
          ...
          // support obsidiant image link type. ![[image-filename.png]]
          //@ts-ignore
          output = output.replaceAll('!\\[\\[', '![[');
         // fix indentation issue
          output = output.replace(/- {2,}/g, '- ');
          //remark use 4 space to indent https://github.com/syntax-tree/mdast-util-to-markdown/blob/main/lib/handle/list-item.js#L41
          //@ts-ignore
          output = output.replaceAll('    ', '\t');
